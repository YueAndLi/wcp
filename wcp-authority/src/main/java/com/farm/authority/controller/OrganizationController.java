...
public class OrganizationController extends WebUtils {
    ...
    public Object loadTreeNode(String id) {
        ...
        try {
            return EasyUiTreeNode
                    .formatAsyncAjaxTree(
                            EasyUiTreeNode.queryTreeNodeOne(id, "SORT", "KNOW_ALONE_AUTH_ORGANIZATION", "ID", "PARENTID",
                                    "NAME", "CTIME").getResultList(),
                            EasyUiTreeNode
                                    .queryTreeNodeTow(id, "SORT", "KNOW_ALONE_AUTH_ORGANIZATION", "ID", "PARENTID", "NAME", "CTIME")
    ...
    public Object loadTreeNode(String id, HttpSession session) {
        ...
        DataQuery query1 = EasyUiTreeNode.queryTreeNodeOneAuth(id, "SORT", "KNOW_ALONE_AUTH_ORGANIZATION", "ID", "PARENTID",
                "NAME", "CTIME", null, null, authFlag);
        DataQuery query2 = EasyUiTreeNode.queryTreeNodeTowAuth(id, "SORT", "KNOW_ALONE_AUTH_ORGANIZATION", "ID", "PARENTID",
