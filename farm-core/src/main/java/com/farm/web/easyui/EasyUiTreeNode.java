...
public class EasyUiTreeNode implements Serializable {
     ...
     * @param id       当前节点id
     * @param text     当前节点名称
     * @param state    当前节点状态'open' 或者 'closed'
     */
     ...
     * 格式化异步ajax子树数据
     *
     * @param result1       依据父id查询出来的节点集合
     * @param result2       依据父id查询出来的节点的子节点集合
     * @param parentIdIndex 父id的key
     * @param idIndex       id的key
     * @param titleIndex    显示字段的key
     * @return
     */
     ...
     * @param idIndex          id的key
     * @param titleIndex       显示字段的key
     * @param iconIndex        图标的key
     * @param urlIndex         url的key
     * @param paramsIndex      url参数的key
     * @param currentUserMenus 当前用户所拥有的菜单，用来做权限过滤的
     * @return
     */
     ...
     *
     * @param parentId       父亲节点id
     * @param SortTitle      排序字段index
     * @param tableTitle     表名index
     * @param id_title       表id的index
     * @param parentId_title 表parentid的index
     * @param name_title     表name的index
     * @return DataResult
     */
     ...
     * 格式化easyUi树节点集合
     *
     * @param resultList  结果集合List<Map<String, Object>>
     * @param resultList
     * @param parentIndex
     * @param idIndex
     * @param titleIndex
