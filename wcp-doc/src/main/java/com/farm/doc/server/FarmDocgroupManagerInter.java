...
public interface FarmDocgroupManagerInter {
     ...
     * @param grouptag    小组tag
     * @param groupimg    小组头像
     * @param joincheck   加入小组是否需要验证
     * @param groupnote   小组备注
    ...
    /**
     * 创建一个外连接小组用户的查询用来查询当前工作小组实体farm_docgroup a left join KNOW_FARM_DOCGROUP_USER b
     *
     * @param query 传入的查询条件封装
     * @return
     */
