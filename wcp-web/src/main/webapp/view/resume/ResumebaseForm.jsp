        ...
        <form id="dom_formResumebase">
            ...
            <table class="editTable">
                <tr>
                    ...
                    <td colspan="3">
                        <select name="registered" id="entity_registered" val="${entity.registered}">
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <input id="entity_dateyear" name="dateyear" value="${entity.dateyear}" type="text"
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <select name="registeredarea" id="entity_registeredarea" val="${entity.registeredarea}">
                            <option value="0">NONE</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3">
                        <input id="entity_birthday" name="birthday" value="${entity.birthday}" type="text"
                               class="easyui-datebox"></input>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3">
                        <select name="sex" id="entity_sex" val="${entity.sex}">
                            <option value="0">NONE</option>
                        </select>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <select name="livestrarea" id="entity_livestrarea" val="${entity.livestrarea}">
                            <option value="0">NONE</option>
                        </select>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <input type="text" style="width: 360px;" class="easyui-validatebox"
                               data-options="validType:[,'maxLength[8]']"
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <select name="marriagesta" id="entity_marriagesta" val="${entity.marriagesta}">
                            <option value="0">NONE</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3">
                        <select name="nationality" id="entity_nationality" val="${entity.nationality}">
                            <option value="0">NONE</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3">
                        <select name="othertype" id="entity_othertype" val="${entity.othertype}">
                            <option value="0">NONE</option>
                        </select>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td colspan="3">
                        <select name="studyabroad" id="entity_studyabroad" val="${entity.studyabroad}">
                            <option value="0">NONE</option>
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="3">
                        <select name="zzmm" id="entity_zzmm" val="${entity.zzmm}">
                            <option value="0">NONE</option>
                        </select>
                    </td>
                </tr>
    ...
    <div data-options="region:'south',border:false">
        <div class="div_button" style="text-align: center; padding: 4px;">
            <c:if test="${pageset.operateType==1}">
                <a id="dom_add_entityResumebase" href="javascript:void(0)" iconCls="icon-save"
                   class="easyui-linkbutton">增加</a>
            </c:if>
            <c:if test="${pageset.operateType==2}">
                <a id="dom_edit_entityResumebase" href="javascript:void(0)" iconCls="icon-save"
                   class="easyui-linkbutton">修改</a>
            </c:if>
            <a id="dom_cancle_formResumebase" href="javascript:void(0)" iconCls="icon-cancel" class="easyui-linkbutton"
