                    ...
                    <div class="media-body">
                        <div style="margin-left: 4px;" class="pull-left">
                            <div class="doc_node_title_box">
                                <c:if test="${node.DOMTYPE=='file'}">
                                    <a class="doc_node_title_min"
                                       href="javascript:;" onclick="toFile('','${node.ID}')">${node.TITLE}<span
                                            style="color: #d9534f;"
                                            class="glyphicon glyphicon-download-alt"></span></a>
                                </c:if>
                                <c:if test="${node.DOMTYPE!='file'}">
                                    <a class="doc_node_title_min"
                                       href="webdoc/view/Pub${node.ID}.html">${node.TITLE}
                                        <c:if
                                                test="${node.DOMTYPE=='3'}">
                            ...
                            <div class="side_unit_info side_unit_info_left_box">
                                <a style="text-decoration: none;cursor: default;" title="${node.AUTHOR}"> <span title=""
