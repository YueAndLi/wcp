            ...
            <div class="col-md-9">
                <div class="panel panel-default">
                    <div class="panel-body">
                        <jsp:include
                                page="../know/commons/doc.jsp"></jsp:include>
                    </div>
                </div>
...
<a id="scrollToTOP">
    <img src="<PF:basePath/>/text/img/top.png" title="返回顶部" id="gotop" alt="返回顶部"
         style="position: fixed;bottom: 30px;right: 50px;">
</a>
<%--<a href="javascript:returnToType()">
    <img src="<PF:basePath/>/text/img/return.png" title="返回" id="return" alt="返回"
         style="position: fixed;bottom: 30px;right: 50px;">
</a>--%>
