                    ...
                    <div class="panel-body">
                        ...
                        <table class="table">
                            <tr>
                                ...
                                <td><a href="Mailto:<PF:ParameterValue key="config.about.email"/>"><PF:ParameterValue
                                        key="config.about.email"/></a></td>
                            </tr>
                            <tr>
                                <td style="font-weight: bold;">QQ</td>
                                <td><a
                                        href="http://wpa.qq.com/msgrd?v=3&uin=<PF:ParameterValue key="config.about.qq"/>&site=qq&menu=yes"><PF:ParameterValue
                                        key="config.about.qq"/></a></td>
                            </tr>
                        </table>
                    </div>
                </div>
